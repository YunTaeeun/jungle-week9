...
{
    int64_t ret;
    register uint64_t *num __asm__("rax") = (uint64_t *)num_;
    register uint64_t *a1 __asm__("rdi") = (uint64_t *)a1_;
    register uint64_t *a2 __asm__("rsi") = (uint64_t *)a2_;
    register uint64_t *a3 __asm__("rdx") = (uint64_t *)a3_;
    register uint64_t *a4 __asm__("r10") = (uint64_t *)a4_;
    register uint64_t *a5 __asm__("r8") = (uint64_t *)a5_;
    register uint64_t *a6 __asm__("r9") = (uint64_t *)a6_;
